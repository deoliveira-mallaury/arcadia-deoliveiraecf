 ...
 */
final class Version20241105142317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE repport_logs (id INT NOT NULL, modified_by_id INT NOT NULL, modified_animal_id INT DEFAULT NULL, modified_habitat_id INT DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modified_field VARCHAR(255) NOT NULL, new_value VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1DCAD8AB99049ECE ON repport_logs (modified_by_id)');
        $this->addSql('CREATE INDEX IDX_1DCAD8AB92253057 ON repport_logs (modified_animal_id)');
        $this->addSql('CREATE INDEX IDX_1DCAD8ABAE39EF3C ON repport_logs (modified_habitat_id)');
        ...
        $this->addSql('ALTER TABLE repport_logs ADD CONSTRAINT FK_1DCAD8AB92253057 FOREIGN KEY (modified_animal_id) REFERENCES animal (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE repport_logs ADD CONSTRAINT FK_1DCAD8ABAE39EF3C FOREIGN KEY (modified_habitat_id) REFERENCES habitat (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repport_logs DROP CONSTRAINT FK_1DCAD8AB92253057');
        $this->addSql('ALTER TABLE repport_logs DROP CONSTRAINT FK_1DCAD8ABAE39EF3C');
