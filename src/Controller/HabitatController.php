...
{
    #[Route(name: 'app_habitat', methods: ['GET'])]
    public function index(HabitatRepository $habitatRepository,EntityManagerInterface $entityManager): Response
    {
        $habitatRepository = $entityManager->getRepository(Habitat::class);
        $habitats = $habitatRepository->findAll();

        return $this->render('habitat/indexHabitat.html.twig', [
            'habitats' => $habitats,
        ]);
    }
